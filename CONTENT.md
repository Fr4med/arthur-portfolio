...
The merged opening loads the supplied Panasonic HMC150 GLB from public/models. Native scroll moves it down, rotates it through 360 degrees and tilts it 90 degrees toward the viewer. After it holds facing forward, it fades as the original hero content pops into place. The navigation stays at the top. The existing charcoal background continues through both phases. Grained plastic, rubber, brushed metal and woven-strap textures are generated locally; the microphone keeps its baked textures. Scrolling backward reverses the sequence. Reduced motion, no JavaScript or a WebGL/load failure reveals the original hero directly. See THREEJS.md for timing, material and rollback details.
